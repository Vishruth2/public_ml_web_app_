...
diabetes_model_path = os.path.join(script_directory, 'Diabetic_model.sav')
heart_model_path = os.path.join(script_directory, 'heart_model.sav')
parkinsons_model_path = os.path.join(script_directory, 'Parkinson_model.sav')
...
#diabetes_model = pickle.load(open('D://Project//models//Diabetic_model.sav', 'rb'))
#diabetes_model = pickle.load(open('Diabetic_model.sav', 'rb'))

#heart_disease_model = pickle.load(open('D://Project//models//heart_model.sav','rb'))
#heart_disease_model = pickle.load(open('heart_model.sav','rb'))

#parkinsons_model = pickle.load(open('D://Project//models//Parkinson_model.sav', 'rb'))
